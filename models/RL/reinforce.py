...
class Reinforce():
    def __init__(self, sess, optimizer, policy_network, max_layers, global_step,
        ...
        self.reg_param = reg_param  # Parameter for regularization
        self.discount_factor = discount_factor
        self.max_layers = max_layers  # The maximum number of layers
        self.global_step = global_step
        self.exploration = exploration  # The probability of generating random action
